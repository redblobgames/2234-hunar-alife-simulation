...
The video has inspired lots of contributions to the original code, so [[https://github.com/hunar4321/life_code/][check it out on github]]. My page was inspired by the video but I can't keep up with all the open source contributions the original gets. :-)
